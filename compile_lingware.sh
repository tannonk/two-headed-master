...
archimob/create_simple_lexicon.py -v $vocabulary -c $GRAPHEMIC_CLUSTERS \
				  -o $lexicon
...
utils/lang/prepare_lang.sh --phone-symbol-table $phone_table $lexicon_tmp \
			   "$SPOKEN_NOISE_WORD" $prepare_lang_tmp $tmp_lang
